...
import { MOBILE_BOTTOM_SHEET_PANEL_CLASS } from '../../shared/constants/dashboard-layout';
...
export function MobileBottomSheet({
  ...
  return (
    <aside className={MOBILE_BOTTOM_SHEET_PANEL_CLASS}>
      {/* 드래그 핸들 (모바일 전용) */}
      <div 
        className="flex w-full cursor-pointer items-center justify-center pb-2 pt-3"
