...
export const SEVERE_CONDITION_OPTIONS: SevereConditionOption[] = [
  ...
  },
  {
    ...
    label: '심근경색 재관류',
    shortLabel: '심근경색',
    description: '공식 중증질환 수용 가능 정보에서 심근경색 재관류 항목을 확인합니다.',
    tyCodes: ['ty1'],
  },
  {
    id: 'stroke_bleeding',
  ...
  },
  {
    ...
    label: '대동맥·복부응급',
    shortLabel: '외상/복부',
    description: '추락·중증 외상 의심 상황에서 확인할 수 있는 대동맥·복부응급 관련 항목입니다.',
    tyCodes: ['ty5', 'ty9'],
  },
  {
    id: 'amputation',
    label: '사지접합',
    shortLabel: '절단',
    description: '수족지 접합 등 사지접합 가능 여부를 확인합니다.',
    tyCodes: ['ty21'],
  },
  {
  ...
  },
  {
    ...
    label: '야간·휴일 소아진료',
    shortLabel: '소아야간',
    description: '일반 소아과가 아니라 달빛어린이병원 성격의 야간·휴일 소아진료 자원만 봅니다.',
    tyCodes: [],
  },
];
