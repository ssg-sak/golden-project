...
| `frontend/public/data/reports/daegu-golden-time-policy-analysis-report.pdf` | 논문식 검증본 Release `2026-07-18-r2`·Population `2026.06`·3,202,576바이트·20쪽 | SHA-256 `A43ED0BD…AAB988D`; 전체 페이지 렌더링 시각 검토 통과; 최신 대시보드 릴리스와 기준월이 다른 고정 스냅샷 |
